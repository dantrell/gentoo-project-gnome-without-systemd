...
If at all possible, release updates (such as 3.34 to 3.36) will occur at least twice per year.
...
* via the [support thread](https://forums.gentoo.org/viewtopic-t-1095396.html) where others can chime in as well; or
